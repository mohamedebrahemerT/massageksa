...
@section('content')
   ...
   <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$WhoWeAre->title_name_ar}}</td>
                  <td>
        <a type="button" class="btn btn-info" href="WhoWeAre/{{$WhoWeAre->id}}/edit">{{trans('admin.edit')}}</a></td>
              
                  <td>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#dell_admin{{$WhoWeAre->id}}">{{trans('admin.delete') }}</button>

                    <div id="dell_admin{{$WhoWeAre->id}}" class="modal fade" role="dialog">
  <div class="modal-dialog">
   ...
   {!! Form::open(['url'=>['admin/WhoWeAre/'.$WhoWeAre->id],'method'=>'delete']) !!}
