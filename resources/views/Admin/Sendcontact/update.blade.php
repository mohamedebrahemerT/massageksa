...
@section('content')
 ...
 @push('js')
             ...
             <script type="text/javascript">
              ...
              url:'{{ url('admin/Sendcontact')}}/{{$Sendcontact->id}}',
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Sendcontact')}}</a></li>
       ...
       {{  Form::open(['url'=>'admin/Sendcontact','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.Sendcontact.updattabs.Sendcontact_name_en')
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Sendcontact/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
