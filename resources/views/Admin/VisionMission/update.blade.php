...
@section('content')
 ...
 @push('js')
   ...
   var VisionMission_name_en = $('.VisionMission_name_en').val();
  ...
  <div class="alert alert-success sucess_message hidden">
                ...
                <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/VisionMission/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
