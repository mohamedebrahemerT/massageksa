...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'newes_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'newes_name_ar' , {
        language: '{{session('lang')}}',
});
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var newes_name_ar = CKEDITOR.instances.newes_name_ar.getData();
          var newes_name_en = CKEDITOR.instances.newes_name_en.getData();
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "newes_name_en": newes_name_en,
        "newes_name_ar": newes_name_ar,
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.newes_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.newes_name_arr')}}</a></li>
                    <li><a data-toggle="tab" href="#is_admin"><i class="fa fa-circle"></i> {{trans('admin.type')}}</a>
       ...
       {{  Form::open(['url'=>'admin/newes','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.newes.updattabs.newes_name_en')
              @include('Admin.newes.updattabs.newes_name_ar')
                    @include('Admin.newes.updattabs.is_admin')
        
          @include('Admin.newes.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/newes/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
