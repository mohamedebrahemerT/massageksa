...
@section('content')
 ...
 @push('js')
          ...
          var title_name_ar = $('.title_name_ar').val();  
           ...
           var Ourworks_name_en = $('.Ourworks_name_en').val();
          var Ourworks_name_ar = $('.Ourworks_name_ar').val();  
              ...
              url:'{{ url('admin/Ourworks')}}/{{$Ourworks->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "Ourworks_name_en": Ourworks_name_en,
        "Ourworks_name_ar": Ourworks_name_ar,
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.Ourworks') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-info"></i> {{trans('admin.Ourworks_name_en')}}</a></li>

       <li><a data-toggle="tab" href="#department"><i class="fa fa-circle"></i> {{trans('admin.Ourworks_name_ar')}}</a></li>
 
             <li><a data-toggle="tab" href="#menu5"><i class="fa fa-camera"></i> {{trans('admin.photo')}}</a></li>

  </ul>  
   
       {{  Form::open(['url'=>'admin/Ourworks','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

        @include('Admin.Ourworks.updattabs.Ourworks_name_en')
              @include('Admin.Ourworks.updattabs.Ourworks_name_ar')
        
          @include('Admin.Ourworks.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/Ourworks/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
