...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">{{ trans('admin.productes') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                     fhgfdhfd

                       {{  Form::open(['url'=>'admin/productes/'.$productes->id,'method'=>'put','files'=>true] ) }}
        <div class="form-group">
            {!! Form::label('title',trans('admin.title')) !!}
            {!! Form::text('title',$productes->title,['class'=>'form-control']) !!}
        </div>
