  ...
  <div class="full-title">
        ...
        <section class="categories_product_main p_80">
           ...
           @foreach($products  as $product)
               ...
               <img src="{{url('/')}}/{{substr($product->photo, -29) }}" alt="" height="400">
...
@endif
  ...
  <aside class="l_widgest l_feature_widget">
            ...
            <a href="{{url('/')}}/pen/{{$FeaturedProduct->id}}">
                                            ...
                                            <img src="{{url('/')}}/{{substr($FeaturedProduct->photo, -29) }}" alt="" width="100" height="100">
...
@endif
                                            ...
                                            <h5>
                                                ...
                                                <del>{{$FeaturedProduct->price }}</del>  {{$FeaturedProduct->price_offer }}
