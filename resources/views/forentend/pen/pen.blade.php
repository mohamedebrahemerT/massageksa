 ...
 <div class="product-section container">
        <div>
            <div class="product-section-image">
                <img src="{{url('/')}}/{{substr($pen->photo, -29) }}" alt="product" class="active" id="currentImage">
            </div>
...
@endif 
					...
					<h3 class="my-3"> {{trans('admin.product_info')}}</h3>
					<ul>
						<li><span> 
                        @if(session('lang')=='ar')
                        ...
                        @endif
						 :</span><span>
{{trans('admin.department_id')}}
					 
					</span></li>
						<li><span>     {{$pen->price }} :</span><span> {{trans('admin.price')}}</span></li>
