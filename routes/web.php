...
Route::get('/', 'homeForentEndController@main');
...
Route::get('/WhyHonesty ', 'AboutController@WhyHonesty');
Route::get('/WhyHonesty/{id}', 'AboutController@viewphoto');
...
Route::get('/newess', 'newesforentcontrller@newes')->middleware('auth');
