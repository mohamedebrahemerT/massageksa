           ...
           return [
            ...
            [
              ...
              [
               ...
               'title'=>trans('admin.subcategories_name_'.session('lang')),

            ],

              [
                 'name'=> 'Maincategories_name_'.session('lang'),
                'data'=> 'Maincategories_name_'.session('lang'),
               'title'=>trans('admin.Maincategories_id'),
